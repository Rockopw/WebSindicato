...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   if (empty($dni) || empty($contrasena_ingresada)) {
        ...
        $sql = "SELECT id_administrador, nombre, apellido, contrasena FROM admin_deporte 
                WHERE dni = :dni";
...
<head>
    ...
    <link rel="stylesheet" href="estilo_loginAdmin_depo.css">
...
<body>
    ...
    <div class="container login-container">
        <h1>Acceso Administrador Sectretaria de Deportes</h1>
...
<!-- aca le puse el ojito para ayudar a ver la pasw -->
    ...
    >
            ...
            <a href="recuperar2.php" style="color: #007bff; text-decoration: none; font-size: 0.9em;">
