...
try {
    ...
    $sql = "SELECT r.*, c.nombre as depto_nombre, a.nombre as nombre_afiliado_db 
...
<head>
    <meta charset="UTF-8">
    <title>Comprobante Departamentos#<?php echo $id_reserva; ?></title>
    ...
    <style>
        ...
        .voucher-card { background: white; max-width: 650px; margin: 0 auto; padding: 40px; border-radius: 12px; box-shadow: 0 5px 15px rgba(0,0,0,0.1); border-top: 8px solid #8ccad2; }
        .header { text-align: center; border-bottom: 2px solid #eee; padding-bottom: 20px; margin-bottom: 20px; }
        .logo { font-weight: bold; color: #5d4037; font-size: 24px; margin: 0; }
        .section { margin: 25px 0; }
        .section h4 { color: #5d4037; margin-bottom: 8px; font-size: 16px; text-transform: uppercase; letter-spacing: 1px; border-bottom: 1px solid #a8e7f5; }
        ...
        .btn-print { display: block; width: 20%; padding: 10px; background: #253d6d; color: white; text-align: center; text-decoration: none; border-radius: 10px; margin-top: 20px;margin: 20px auto ; font-weight: bold; }
...
.btn-volver {
    ...
    width: 40%;
    padding: 12px 20px;
    background: linear-gradient(135deg,  #4a76d0 0%,  #253d6d 100%);
...
<div class="voucher-card">
    <div class="header">
        ...
        <p style="margin: 5px 0; color: #666666;">Sindicato de Obras Sanitarias Misiones</p>
    </div>

    <div class="section">
        <h4>🏙️ Detalles del Alojamiento</h4>
        <p><strong>Alojamiento:</strong> <?php echo htmlspecialchars($reserva['depto_nombre']); ?></p>
        <p><strong>Ubicación:</strong> Lavalle 2445 - Posadas.</p>
    </div>
...
<p style="text-align: center; font-size: 12px; color: #444; margin-top: 30px;">
    ...
    <div style="text-align: center;">
        <a href="reserva_departamentos.php" class="btn-volver">
