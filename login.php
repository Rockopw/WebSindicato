...
if (isset($_SESSION['afiliado_id'])) {
    header("Location:espacio_de_reservas.php");
    exit();
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   if (empty($dni) || empty($contrasena_ingresada)) {
        ...
        $sql = "SELECT afiliados_id, nombre, apellido, contrasena FROM afiliados 
                WHERE dni = :dni";
        ...
        if ($afiliado) {
            ...
            if (password_verify($contrasena_ingresada, $afiliado['contrasena'])) {
                // Login exitoso
                $_SESSION['afiliado_id'] = $afiliado['afiliados_id'];
                $_SESSION['afiliado_nombre'] = $afiliado['nombre'] . " " . $afiliado['apellido'];
...
<body>
    ...
    <div class="container login-container">
        <h1>Acceso de Afiliados</h1>
        <p>Ingrese sus credenciales para acceder a las reservas.</p>
...
<!-- aca le puse el ojito para ayudar a ver la pasw -->
    ...
    >
            ...
            <a href="recuperar.php" style="color: #007bff; text-decoration: none; font-size: 0.9em;">
